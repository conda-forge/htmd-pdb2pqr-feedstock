About htmd-pdb2pqr-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/htmd-pdb2pqr-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/tonigi/apbs-pdb2pqr
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6661&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/htmd-pdb2pqr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `htmd-pdb2pqr` can be installed with `conda`:
...
```
mamba install htmd-pdb2pqr
```

It is possible to list all of the versions of `htmd-pdb2pqr` available on your platform with `conda`:
...
```
mamba search htmd-pdb2pqr --channel conda-forge
```
...
mamba repoquery search htmd-pdb2pqr --channel conda-forge

# List packages depending on `htmd-pdb2pqr`:
mamba repoquery whoneeds htmd-pdb2pqr --channel conda-forge

# List dependencies of `htmd-pdb2pqr`:
mamba repoquery depends htmd-pdb2pqr --channel conda-forge
```
